...
INSERT INTO "new_products" ("categoryId", "description", "featured", "id", "idReference", "name", "price") SELECT "categoryId", "description", "featured", "id", "idReference", "name", "price" FROM "products";
DROP TABLE "products";
