...
INSERT INTO "new_products" ("categoryId", "createdAt", "description", "featured", "id", "idReference", "name", "price", "slug") SELECT "categoryId", "createdAt", "description", "featured", "id", "idReference", "name", "price", "slug" FROM "products";
DROP TABLE "products";
